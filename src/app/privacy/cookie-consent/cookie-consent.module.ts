...
const route: Routes = [
  ...
  {
    path: 'banner-configuration', loadChildren: () => import('./banner-config/banner-config.module').then(m => m.BannerConfigModule), canActivate: [AuthGuard,RouteguardService,LicenseguardPropertyService]
  },
  {
